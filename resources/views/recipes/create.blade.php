...
@section('content')
    ...
    <form action="/recipes" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <h1 class="text-center fw-bold shadow-sm bg-body rounded">{{ __('Create recipe!') }}</h1>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="ingredients[]" placeholder="{{ __('Chicken - 300g') }}" required>
